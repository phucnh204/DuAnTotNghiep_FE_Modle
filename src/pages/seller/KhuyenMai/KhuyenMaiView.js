        ...
        <>
            ...
            <div style={{ borderRadius: '7px' }} className="shadow-md mt-3 container mx-auto p-4 relative bg-white">
                ...
                <div class="container mx-auto mt-3">
                    <div class="container mx-auto mt-3">
                        <div class="grid grid-cols-12 gap-4">
                            <div class="col-span-12 lg:col-span-2 text-sm  lg:text-right sm:text-left">Mua với .. để giảm</div>

                            <div class="col-span-12 lg:col-span-10  ">
                                <input
                                    value={khuyenMai.soLuongToiThieu}
                                    onChange={(e) => {
                                        khuyenMai.soLuongToiThieu = e.target.value;
                                        setFlag(flag + 1);
                                    }}
                                    min={0}
                                    type="number"
                                ...
                                />
                                <p className="hidden lg:block text-xs mt-2 text-danger">
                                    {khuyenMai.soLuongToiThieu < 0 ? 'Số lượng tối thiểu phải lớn hơn =0' : ''}
                                </p>
                            </div>
                        </div>
                    </div>
