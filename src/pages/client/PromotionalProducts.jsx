...
const PromotionalProducts = () => {
  ...
  const handleFilterChange = (filterType, value, isChecked) => {
    setSelectedFilters((prevFilters) => {
      ...
      navigate(`/PromotionalProducts?${queryParams}`);
  ...
  const fetchProducts = async () => {
    try {
      ...
      const response = await axios.get(
        `http://localhost:8080/PromotionalProducts`,
        {
          params: {
            page: currentPage,
            size: 1,
        ...
        <div className="container">
          <div className="tf-shop-control grid-3 align-items-center">
            ...
            <ul className="tf-control-layout d-flex justify-content-center">
              ...
              >
                <div className="item">
                  <h6>--Các sản phẩm đang được khuyến mãi--</h6>
                </div>
              </li>
              {/* Các layout khác */}
            </ul>
          ...
          <ul className="tf-pagination-wrap tf-pagination-list">
            ...
            {[...Array(totalPages)].map((_, index) => {
              ...
              const isNearCurrent = Math.abs(index - currentPage) <= 2; // Hiển thị 2 trang trước và sau
              ...
              if (isStart || isEnd || isNearCurrent) {
                ...
                (index === currentPage + 3 && index < totalPages - 2)
              ) {
                return (
              ...
              return null; // Không hiển thị các trang xa
            })}
